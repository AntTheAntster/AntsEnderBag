package uk.co.anttheantster.antsenderbag;
...
import uk.co.anttheantster.antsenderbag.utils.VersionChecker;

@Mod(AntsEnderBag.MODID)
public class AntsEnderBag {
    public static final String MODID = "antsenderbag";
    public static final String version = "1.0.0";

    public AntsEnderBag(IEventBus modEventBus, ModContainer modContainer) {
