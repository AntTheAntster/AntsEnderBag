...
public class VersionChecker {
    ...
    private static final String VERSION_URL = "https://raw.githubusercontent.com/AntTheAntster/AntsEnderBag/refs/heads/main/version.json";
        ...
        if (!checked && Minecraft.getInstance().player != null) {
            ...
            new Thread(() -> {
                try {
                    ...
                    if (!latestVersion.equals(AntsEnderBag.version)){
    ...
    private static void displayMessage(Player player){
        player.displayClientMessage(
                Component.literal("§cAnt's Ender Bag is outdated! You're using " + AntsEnderBag.version + "! Please update to " + latestVersion + "!"),
                false);
        player.displayClientMessage(
